    ...
    return(
        <div className="w-[448px] rounded overflow-hidden">
          ...
          <div className="bg-zinc-200 dark:bg-zinc-800 py-4 px-6 flex items-center justify-between">
            ...
            <button className="text-violet-500 font-bold text-xs" >MARCAR TODAS COMO VISTAS</button>
          </div>
        ...
        <div className='divide-y-2  divide-zinc-300 dark:divide-zinc-950'>
            <div className=" bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
                ...
                <div className='flex-1 flex flex-col gap-2'>
                    <p className='text-sm leading-relaxed text-zinc-500 dark:text-zinc-100'>
           ...
           {/*Antigas*/}
          <div>
            <div className="bg-zinc-300 dark:bg-zinc-950 font-medium  px-5 py-2 text-sm text-zinc-400">
                Antigas
            </div>
